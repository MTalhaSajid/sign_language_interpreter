          ...
          Positioned(
            ...
            child: FadeTransition(
              ...
              child: const Text('v1.0.0',
                  ...
                  style: TextStyle(
                      fontSize: 10, color: _dimText, letterSpacing: 2.5)),
            ),
          ),
        ],
      ),
        ...
        child: AnimatedBuilder(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: _teal.withOpacity(0.20), width: 1),
            ),
            child: Padding(
              padding: const EdgeInsets.all(9),
              // ── Image asset replaces emoji ──────────────────────────
              child: ClipRRect(
          ...
          children: [
            ShaderMask(
              shaderCallback: (bounds) => const LinearGradient(
                  colors: [_teal, _blue]).createShader(bounds),
              child: const Text(
                'Sign Talk',
                style: TextStyle(
                  fontSize: 34,
      ...
      child: Column(
        children: [
                ...
                child: Stack(children: [
                  ...
                  FractionallySizedBox(
                    ...
                    child: Transform.translate(
                      offset: Offset(
                          (_loaderCtrl.value * 110 * 2.5) - 50, 0),
                      child: Container(
          ...
          const Text('INITIALIZING',
              style: TextStyle(
                  fontSize: 9, color: _dimText, letterSpacing: 2.5)),
        ],
      ),
    );
  }
